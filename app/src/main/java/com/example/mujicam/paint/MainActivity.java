package com.example.mujicam.paint;
...
// Import para los botones superiores
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.draw_btn){
            ...
            newDialog.setTitle("Borrar todo");
            newDialog.setMessage("¿Esta Seguro de que quiere borrar todo?");
